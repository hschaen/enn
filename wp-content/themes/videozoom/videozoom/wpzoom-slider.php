...
<h2 class="title"><a href="<?php the_permalink() ?>" title="<?php the_title(); ?>"><?php the_title(); ?></a></h2>
                    ...
                    <p class="postmetadata">
						...
						<?php if (option::get('slider_date') == 'on') { ?><?php printf('%s at %s', get_the_date(), get_the_time()); if (option::get('slider_category') == 'on') { echo " "; } } ?><?php if (option::get('slider_author') == 'on') { ?><?php _e('by', 'wpzoom');?> <?php the_author_posts_link(); } ?><br />
					</p>
					...
					<p class="more"><?php if (option::get('slider_morebtn') == 'on') { ?><a href="<?php the_permalink() ?>" title="<?php the_title(); ?>"><?php _e('Read more', 'wpzoom'); ?> &raquo;</a><?php } ?> <?php edit_post_link( __('Edit', 'wpzoom'), ' ', ''); ?></p><p class="postmetadata"><?php if (option::get('slider_category') == 'on') {  the_category(', '); if (option::get('slider_author') == 'on') { echo ""; } } ?></p>
