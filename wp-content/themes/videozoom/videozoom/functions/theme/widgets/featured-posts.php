...
class wpzoom_widget_video_posts extends WP_Widget {
   ...
   <p>&nbsp;</p>
		<div id="postFuncs">
			<h1><?php if ($categoryLink1) { ?><?php echo "$title"; ?><?php } else { echo "$title"; } ?></h1>
		</div><!-- /#postFuncs -->
		<?php
		...
		<li<?php if ($i == 4 && option::get('sidebar_home') == 'on') {$i = 0; echo " class=\"last\"";} elseif ($i == 4 && option::get('sidebar_home') == 'off') {$i = 0; echo " class=\"last\""; } ?>>
